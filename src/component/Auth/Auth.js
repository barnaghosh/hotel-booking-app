    ...
    render() {
        ...
        return (
            <div >
                    ...
                    {this.props.isLoading!==null &&this.props.isLoading.load && this.props.isLoading.state===this.props.auth?<Spinner />:<div><h1 style={{textAlign:'center'}}>{this.props.auth} </h1>
                    {error}
                    {form}</div>} 
